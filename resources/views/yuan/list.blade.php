...
<form action="{{url('yuan/list')}}" method="get" id="form" >
    ...
    <div class="layui-inline">
        ...
        <div class="layui-input-inline" style="width: 200px;">
            <input type="text" name="gongsi" value="{{$gongsi}}" class="layui-input">
        </div>
    </div>
    <div class="layui-inline">
...
<table class="layui-table">
    ...
    <tr u_id="{{$d->u_id}}">
        ...
        <td>{{$d->u_company}}</td>
        <td>{{$d->u_in_time}}</td>
        <td>@if($d->u_sex == 1) 男 @else 女 @endif</td>
        <td>{{$d->u_phone}}</td>
        <td>{{$d->u_id_cart}}</td>
        <td>
            @if($d->u_marriage == 1) 未婚
                @elseif($d->u_marriage == 2) 已婚
                @else 离婚
                @endif
        </td>
        <td>
