...
<div class="order_warp">
    <div class="order_nav clear_both">
        <div class="order_nav_item active"><a class="zhuge_no_pay" href="javascript:;"  data_href="{{url('app/order')}}" data_title="待付款" style="color: #0cd574;">待付款</a> <p></p></div>
        <div class="order_nav_item"><a class="zhuge_is_pay" href="javascript:;"   data_href="{{url('app/orders')}}" data_title="已付款"  > 已付款 </a>
            <p></p></div>
    </div>
    <div class="order_list">
        ...
        <div class="order_item" >
                ...
                @if(empty($data))
                    ...
                    @elseif($d->a_status==2 && $d->p_status==2)
<!--            <div>-->
<!--                <img src="/templates/new_module/images/empty.png" alt="" class="no_data_img">-->
<!--                <p class="no_more no_data_text">您还没有相关订单<br>去下一单试试吧</p>-->
<!--                <div class="jiaona_btn zhuge_jiaoshebao" data_title="订单列表缴社保"  data_href="{{url('/app/shebao')}}" >去缴社保</div>-->
...
<div class="header_footer">
    <ul class="header_footer_list">
        <li class="header_footer_item bottom_zhuge" data_href="{{url('/app/index')}}" data_title="首页">
            <img src="/templates/new_module/images/unchoose_hpmepage@2x.png" alt="" class="header_footer_img" >
            <p >首页</p>
        </li>
...
<script>
    ...
    $('.cancel').click(function () {
        ...
        text = ' <select name="interest" id="cancel_reason" style="width: 100%;"> <option>订单信息有误/重新下单</option> <option>不再需要该服务</option><option>我找到新单位了</option> </select> ';
        layer.open({
