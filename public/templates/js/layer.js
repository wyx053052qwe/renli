        ...
        l.pt.creat = function() {
            ...
            if (!i("#" + t.id)[0]) {
                ...
                t.time <= 0 || setTimeout(function() {
                    ...
                    e.move().callback(),
                s.anim[t.anim] && e.layero.addClass(s.anim[t.anim])
            }
        }
        ,
            ...
            if (t[0]) {
                var l = function() {
                    if (n === o.type[1] && "object" === t.attr("conType")) {
                        ...
                        for (var a = t.find(".layui-layer-wrap"), r = 0; r < 2; r++)
                            a.unwrap();
            ...
            if (t = t || {},
                ...
                l.imgprev = function(e) {
                    ...
                    l.imgnext = function(e, t) {
                        l.imgIndex++,
                        l.imgIndex > u.length && (l.imgIndex = 1,
                            t) || l.tabimg(e)
                    }
                    ,
                    l.keyup = function(e) {
                    ...
                    ,
                    l.tabimg = function(e) {
                        u.length <= 1 || (f.start = l.imgIndex - 1,
                            r.close(l.index),
                            r.photos(t, !0, e))
                    }
                    ,
